...
song_table_insert = ("""INSERT INTO dwh.dim_songs(song_id,title, artist_id, year, duration)
            select distinct
                        song_id, 
                        title, 
                        artist_id, 
...
artist_table_insert = ("""INSERT INTO dwh.dim_artists(artist_id, name, location, latitude, longitude)
            select distinct
                        artist_id, 
                        artist_name, 
                        artist_location, 
...
time_table_insert = ("""INSERT INTO dwh.dim_time(time_key,start_time, hour, day, week, month, year, weekday)
            SELECT distinct
            a.time_key,
            a.start_time,
...
user_table_delete  = ("""DELETE FROM dwh.dim_users u USING staging.events e where u.user_id = e.userId;
""")
song_table_delete  = ("""DELETE FROM dwh.dim_songs d USING staging.songs s where d.song_id = s.song_id;
""")
artist_table_delete = ("""DELETE FROM dwh.dim_artists a USING staging.songs s where a.artist_id = s.artist_id;
""")
time_table_delete = ("""DELETE FROM dwh.dim_time t USING staging.events e where e.start_time = t.time_key;
""")
...
delete_table_queries = [user_table_delete,song_table_delete,artist_table_delete,time_table_delete]
